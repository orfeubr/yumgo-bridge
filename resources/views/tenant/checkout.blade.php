...
<body class="bg-gray-50">
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <button
                            ...
                            class="flex flex-col items-center justify-center gap-3 p-6 border-2 rounded-lg transition hover:border-primary">
                            <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.11-.504 1.11-1.125v-3.75m-17.25 0h16.5m-17.25 0V9.75c0-.621.504-1.125 1.125-1.125H9.75M3.375 14.25V12A2.625 2.625 0 016 9.375h1.5m13.5 5.625V12A2.625 2.625 0 0018.375 9.375h-1.5m-13.5 3.75V9.75c0-.621.504-1.125 1.125-1.125h12.75c.621 0 1.125.504 1.125 1.125v3.75m-13.5 0h13.5"/>
                            </svg>
                            <div class="text-center">
                                <span class="text-base font-bold block">🚚 Delivery</span>
                                <span class="text-xs text-gray-500">Receber em casa</span>
                            </div>
                        </button>
                        ...
                        <button
                            ...
                            :class="serviceType === 'pickup' ? 'border-primary bg-red-50 text-primary' : 'border-gray-300 text-gray-700'"
                            class="flex flex-col items-center justify-center gap-3 p-6 border-2 rounded-lg transition hover:border-primary">
                            <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75v3.75c0 .415.336.75.75.75z"/>
                            </svg>
                            <div class="text-center">
                                <span class="text-base font-bold block">🏪 Retirada</span>
                                <span class="text-xs text-gray-500">Buscar no local</span>
                            </div>
                        </button>
                    </div>
                </div>
    ...
    function checkoutApp() {
        ...
        return {
            ...
            needsChange: false,
            // ⭐ Tipo de entrega (delivery ou pickup)
            serviceType: 'delivery', // delivery = receber em casa, pickup = retirada
            ...
            async submitOrder() {
                ...
                try {
                    ...
                    // Validações removidas (mesa/balcão não existem mais no checkout online)
                    ...
                    const payload = {
                        items: items,
                        service_type: this.serviceType, // ⭐ delivery ou pickup
